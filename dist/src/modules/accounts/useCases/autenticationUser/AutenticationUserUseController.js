...
class AutenticationuserController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authenticationUserUseCase = tsyringe_1.container.resolve(AutenticationUserUseCase_1.AutenticationUserUseCase);
            const token = yield authenticationUserUseCase.execute({ email, password });
