...
class CreateCarSpecificationController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createCarSpecificationCarUseCase = tsyringe_1.container.resolve(CreateCarSpecificationUseCase_1.CreateCarSpecificationUseCase);
            const cars = yield createCarSpecificationCarUseCase.execute({
                car_id: id,
                specification_id
            });
