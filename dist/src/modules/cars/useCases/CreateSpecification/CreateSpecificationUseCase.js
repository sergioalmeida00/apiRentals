...
let CreateSpecificationUseCase = class CreateSpecificationUseCase {
    ...
    execute({ name_specification, description_specification }) {
        return __awaiter(this, void 0, void 0, function* () {
            const specificationAlreadyExists = yield this.specificationsRepository.findBySpecification(name_specification);
            if (specificationAlreadyExists) {
                throw new AppError_1.AppError("Specification already exists");
            }
            const resultSpecification = yield this.specificationsRepository.create({ name_specification, description_specification });
